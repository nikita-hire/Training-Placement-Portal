...
<head>
    ...
    <style>
        .wrapper{
        box-shadow: 20px 20px 30px rgba( 40, 116, 166,0.5);
}
...
<body>
  ...
  <div>
  <img src="d5.jpg" style="height: 600px;width: 700px;margin-left: 10px;margin-top: 20px;background: transparent">
</div>
<div class="wrapper">
<div>
 <h2 style="text-align: center;font-family: Gabriola;font-weight: bold ;font-size: 50px;margin-top: -10px"> Sign In</h2>
          ...
          <?php } ?>
             ...
             <form action="studloginpart2.php" method="POST">
                   <div class="input-data" style="margin-top: 20px;">
                    ...
                    <input type="submit" class="button" name="sbm" value="Sign In" style="margin-left: 120px;width: 140px;height: 40px;font-style: bold;font-family: Gabriola;font-size: 25px">
               </form>
            </div>
