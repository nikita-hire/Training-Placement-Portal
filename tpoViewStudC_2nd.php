...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 300px">Computer-2nd Year Students</h4>
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM student s WHERE stream='2nd Year'";//profile p where s.prn=p.prn ";
