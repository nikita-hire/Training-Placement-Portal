...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">IT- 1st Year Students</h4>
</div>
<div>
  <div style="">
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM itstud where stream ='1st Year' ";//profile p where s.prn=p.prn ";
