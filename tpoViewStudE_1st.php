...
.container td:hover {
  ...
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">Electrical-1st Year Students</h4>
</div>
<div>
  <div style="">
...
<div class="dropdown" style="margin-right: -1050px;margin-top: 30px;">
 ...
 <div id="myDropdown1"  class="dropdown-content">
    <a href="tpoViewStudE_1st.php">1st Year</a>
    <a href="tpoViewStudE_2nd.php">2nd Year </a>
    <a href="tpoViewStudE_3rd.php">3rd Year</a>
    <a href="tpoViewStudE_4th.php">4th Year</a>
  </div>
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM electstud where stream='1st Year'";//profile p where s.prn=p.prn ";
