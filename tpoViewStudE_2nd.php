...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">Electrical- 2nd Year Students</h4>
</div>
<div>
  <div style="">
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM electstud where stream='2nd Year'";//profile p where s.prn=p.prn ";
