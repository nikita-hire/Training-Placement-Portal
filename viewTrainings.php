...
@media screen and (max-width: 600px) {
 ...
 <div  style="margin-top:50px; margin-left: 30px;color: white">
  <h1 style="color:black;font-family:Gabriola;font-size: 35px;"><center><b>TRAINING NOTICE</b></center></h2>
  <br><br>
<div id="body">   
<?php
    ...
    //session_start();
     ...
     $sql="SELECT * FROM uploadattach WHERE section='Trainings' ORDER BY date ASC";
 //$result=mysqli_query($con,$sql);
    ...
    if($result-> num_rows > 0)
    {
      ...
      {  ?> 
        <form method="POST" action="viewTrainings.php?id=<?=$row['id']?>">
        ...
        <td><center><?php echo $row[3]?></center></td>
         ...
         <input type='submit'class="dropbtn"  value='VIEW FILE'></center></a></td>
          <form method="POST" action="viewTrainings.php?id=<?=$row['id']?>" onsubmit="alert('Successfully Applied!!');">
