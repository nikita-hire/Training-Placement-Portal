...
@media screen and (max-width: 600px) {
  ...
  <div><?php 
      session_start(); 
      error_reporting(0);?> 
      <h3 style="margin-top: -60px;color: white;margin-left: 1200px "><?php  
      echo $_SESSION['prn']. "-" .$_SESSION['name'] ; 
      $prn=$_SESSION['prn'];
    ?>
	</div>
	<div> 
    <img src="<?php echo 'image/'.$_SESSION['proimg'];?>"style="height: 50px;width: 50px;margin-top: -80px;border-radius: 70px;margin-left: 1460px "> 
      </h3>
      </div>  
    ...
    <div class="wrapper" style="margin-top: 20px;position: fixed">
      ...
      <nav id="sidebar" style="position: fixed;">
        ...
        <ul class="list-items">
          <li><a href="studdash.php"><i class="fas fa-home"></i>Dashboard<a></li>
          <li><a href="studProfile.php"><i class="fas fa-user"></i>Profile</a></li>
          <li><a href="studlogout.php"><i class="fa fa-power-off"></i>Log Out</a></li>
