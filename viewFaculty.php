...
.container td:hover {
  ...
  transition-timing-function: line;
    ...
    <title>Department TPO Information</title>
...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 300px">Department TPO Information</h4>
</div>
<div>
  <br><br>
<?php
	...
	{
		header('Location:http://localhost/Waste%20management/prologin.php');
	}*/
	echo "<center><table class='container'>";
	echo "<tr>";
	echo "<th><center>Sr.No</th>";
	echo "<th><center>Name</th>";
	echo "<th><center>Email</th>";
	echo "<th><center>Contact No.</th>";
	//echo "<th><center>Institute Name</th>";
	echo "<th><center>Department</th>";
	echo "</tr>";
