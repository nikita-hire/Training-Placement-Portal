...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">Mechanical- 2nd Year Students</h4>
</div>
<div>
  <div style="">
...
<div class="dropdown" style="margin-right: -1050px;margin-top: 30px;">
 ...
 <div id="myDropdown1"  class="dropdown-content">
    <a href="tpoViewStudM_1st.php">1st Year</a>
    <a href="tpoViewStudM_2nd.php">2nd Year </a>
    <a href="tpoViewStudM_3rd.php">3rd Year</a>
    <a href="tpoViewStudM_4th.php">4th Year</a>
  </div>
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM mechstud where stream ='2nd Year' ";//profile p where s.prn=p.prn ";
