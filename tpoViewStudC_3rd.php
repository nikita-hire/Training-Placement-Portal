...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 300px">Computer-3rd Year Students</h4>
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM student s WHERE stream='3rd Year'";//profile p where s.prn=p.prn ";
