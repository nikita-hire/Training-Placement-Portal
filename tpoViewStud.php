...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 500px">Students Information</h4>
</div>
<div class="dropdown" style="margin-left: 500px;margin-top: 70px;">
