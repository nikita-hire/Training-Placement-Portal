...
.container td:hover {
  ...
  <body>
    ...
    <div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 300px">Mechanical-T&P Reports</h4>
</div>
...
function filterFunction1() {
  ...
  <div><br>
<?php
    $sql="SELECT * FROM historynotice2";
