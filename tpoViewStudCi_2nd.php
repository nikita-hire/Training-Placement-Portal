    ...
    ?></div><div>
      ...
      <nav id="sidebar" style="position: fixed">
        ...
        <ul class="list-items">
          ...
          <li><a href="tpoViewStud.php">View Students</a></li>
...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">Civil-2nd Year Students</h4>
</div>
<div>
  <div style="">
...
<div class="dropdown" style="margin-right: -1050px;margin-top: 30px;">
 ...
 <div id="myDropdown1"  class="dropdown-content">
    <a href="tpoViewStudCi_1st.php">1st Year</a>
    <a href="tpoViewStudCi_2nd.php">2nd Year </a>
    <a href="tpoViewStudCi_3rd.php">3rd Year</a>
    <a href="tpoViewStudCi_4th.php">4th Year</a>
  </div>
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM civilstud where stream ='2nd Year' ";//profile p where s.prn=p.prn ";
