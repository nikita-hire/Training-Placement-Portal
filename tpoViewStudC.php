...
<div>
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 300px">Computer-Students Information</h4>
</div>
<div>
...
<?php
  ...
  echo "<th><center> Enrollment No. </center></th>";
	...
	$sql="SELECT * FROM student s";//profile p where s.prn=p.prn ";
