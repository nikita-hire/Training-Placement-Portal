...
<!--<div>
  <h4 style="text-align: center;margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 50px">1st Year Students</h4>
</div>-->
    
<div  style="margin-top:140px; margin-left: 70px;color: white">
  <h1 style="color: black"><center>1st Year Students</center></h1>
  <br><br>
<div id="body"> <?php
	...
	$sql="SELECT * FROM student s, historynotice h where s.prn=h.prn AND s.stream='1st Year' ";
