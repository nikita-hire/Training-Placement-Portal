...
@media screen and (max-width: 600px) {
  ...
  <body>
   ...
   <div>
    ...
    <img src="logo1.png" style="height: 70px;width: 200px" >
        <h3 style="margin-top: -95px;color: white;margin-left: 990px "><?php
      error_reporting(0);
      echo $_SESSION['name'] ."-";
    ?><img src="s2.png" style="height: 60px;width: 60px;margin-top: 20px;border-radius: 70px;margin-left: 20px ">
  </h3> 
 </div>
  ...
  <h1 style="color: black"><center>Computer-3rd Year T&P Student Report</center></h1>
 ...
 <div id="myDropdown1"  class="dropdown-content">
    <a href="1stViewReports.php">1st Year</a>
    <a href="2ndViewReportsM.php">2nd Year</a>
    <a href="3rdViewReportsCiv.php">3rd Year</a>
    <a href="4thViewReportsI.php">4th Year</a>
  </div>
</div>
  <script>
...
<?php
 ...
 $sql="SELECT * FROM historynotice ORDER BY company";
