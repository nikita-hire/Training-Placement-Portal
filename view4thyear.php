...
<div  style="margin-top:100px; margin-left: 70px;color: white">
  <h1  style="color:black"><center>4th Year Students</center></h1>
  <br>
<div id="body"><?php
  ...
  $sql="SELECT * FROM student s, historynotice h where s.prn=h.prn AND s.stream='4th Year' ";
