...
.container td:hover {
 ...
 <nav style="background: #1b1b1b;height: 70px;">
  ...
  <h4 style="margin-top: 50px;font-family: Gabriola;font-weight: bold;font-size: 70px;color:black;margin-left: 400px">Mechanical- 4th Year Students</h4>
</div>
<div>
  <div style="">
...
<?php
  ...
  //echo "<th><center> Skills         </center></th>";
	...
	$sql="SELECT * FROM mechstud where stream ='4th Year' ";//profile p where s.prn=p.prn ";
