...
@media screen and (max-width: 600px) {
  ...
  <body> 
    ...
    <div class="card">
      ...
      <a href="techViewReports.php" style="border-bottom: none;text-decoration: none"><h3 style="border-bottom: 00px;margin-top: -100px;font-size: 40px;margin-right:-300px;font-family: Comic Sans MS;font-weight: bold;color: black">T & P Reports
    ...
    <div class="card">
      ...
      <a href="selectuploadnotice.php" style="border-bottom: none;text-decoration: none"><h3 style="border-bottom: 00px;margin-top: -100px;font-size: 40px;margin-left:-300px;font-family: Comic Sans MS;font-weight: bold;color: black">Upload Notice
            <!---<i class='fas fa-angle-double-right' style='font-size:36px'></i>--->
      </h3></a>
