...
<div  style="margin-top:40px; margin-left: 30px;color: white">
  <h1 style="color:white;font-family:Gabriola;font-size: 35px;"><b>COMPETITION NOTICE</b></h1>
  <br>
<div id="body">   
<?php
    ...
    $sql="SELECT * FROM uploadattach WHERE section='Competitive Exam' ORDER BY date ASC";
 //$result=mysqli_query($con,$sql);
    ...
    if($result-> num_rows > 0)
    {
      ...
      {  ?> 
        <form method="POST" action="ViewCompetitive.php?id=<?=$row['id']?>">
        ...
        <input type='submit' class="dropbtn" value='VIEW FILE'></center></a></td>
          <form method="POST" action="ViewCompetitive.php?id=<?=$row['id']?>" onsubmit="alert('Successfully Applied!!');">
